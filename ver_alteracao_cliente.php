            ...
            <div class="row mt-4">
                <div class="col-md-5" style="background-color: darkred; color:white">
                    ...
                    <div class="text-center">
                        <h1> Alteração de Cliente </h1> <br>
                        <i class="fas fa-users-cog" style="font-size: 150px;"></i><br><br>
                ...
                <div class="col-md-7 p-3">
                    <h3 class="text-center" style="color: darkred;"><i class="fas fa-users-cog"></i> Alteração de Cliente </h3>
                    <hr class="mb-4">
                    <form method="post" action="alterar_cliente.php" style="margin-left: 70px;">
