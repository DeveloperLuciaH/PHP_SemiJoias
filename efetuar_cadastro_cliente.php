...
$sqlinsert = "insert into cliente values (0, '$nome' , '$cpf' ,'$obs')";
...
if (!$resultado) {
  ...
  echo 
    ...
    <a href="cad_cliente.php" class="btn mx-1 mt-1" style="background-color: darkred; color:white; border-radius: 25px;">Novo Cadastro</a>
    <a href="lista_cliente.php" class="btn mt-1" style="background-color: darkred; color:white; border-radius: 25px;">Ver Cadastro</a></div>';
    }
...
<body>
  ...
  <!-- <input class="btn btn-info mt-2" type='button' onclick="window.location='cad_cliente.php';" value="Voltar"> -->
