            ...
            <div class="row mt-4">
                <div class="col-md-5" style="background-color: darkred; color:white">
                    ...
                    <div class="text-center">
                        <h1> Exclusão de Produtos </h1> <br>
                        <i class="fas fa-cart-arrow-down" style="font-size: 150px;"></i><br><br>
                ...
                <div class="col-md-7 p-3">
                    <h3 class="text-center" style="color: darkred;"> <i class="fas fa-cart-arrow-down"></i> Exclusão de Produto </h3>
                    <hr class="mb-4">
                    <form method="post" action="exclusao_produto.php" style="margin-left: 70px;">
